...
// HeaderVariableContext 存储变量解析的上下文数据
...
// ResolveHeaderVariables 解析头部值中的动态变量
...
// ApplyHeaderRules 将头部规则应用到 HTTP 请求
...
// NewHeaderVariableContextFromGin 从 Gin context 创建 HeaderVariableContext
...
// NewHeaderVariableContext 创建不依赖 Gin context 的 HeaderVariableContext
