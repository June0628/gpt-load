...
var MessagesEnUS = map[string]string{
	...
	"config.balance_query_interval":           "Balance Query Interval (minutes)",
	"config.balance_query_interval_desc":      "Default interval for background balance queries (minutes), independent of key validation interval.",
	...
	"config.category.log_upload": "Log Upload",

	// Log upload related
	"config.log_upload_enabled":                  "Enable Auto Upload",
	"config.log_upload_enabled_desc":             "When enabled, logs will be automatically uploaded to external storage before deletion.",
	"config.log_upload_before_delete":            "Upload Before Delete",
	"config.log_upload_before_delete_desc":       "Automatically upload logs to external storage before they are cleaned up.",
	"config.log_upload_directory":                "Upload Directory",
	"config.log_upload_directory_desc":           "Directory path for storing logs in external storage.",
	"config.log_upload_filename_prefix":          "Filename Prefix",
	"config.log_upload_filename_prefix_desc":     "Prefix identifier for uploaded filenames.",
	"config.log_upload_provider":                 "Upload Provider",
	"config.log_upload_provider_desc":            "Select the target provider for log upload: tencent (Tencent Cloud COS) or webdav.",
	"config.log_upload_tencent_secret_id":        "Tencent SecretId",
	"config.log_upload_tencent_secret_id_desc":   "SecretId credential for Tencent Cloud COS.",
	"config.log_upload_tencent_secret_key":       "Tencent SecretKey",
	"config.log_upload_tencent_secret_key_desc":  "SecretKey credential for Tencent Cloud COS.",
	"config.log_upload_tencent_bucket":           "Bucket Name",
	"config.log_upload_tencent_bucket_desc":      "Tencent Cloud COS bucket name.",
	"config.log_upload_tencent_region":           "Bucket Region",
	"config.log_upload_tencent_region_desc":      "Region of the Tencent Cloud COS bucket, e.g., ap-guangzhou.",
	"config.log_upload_webdav_url":               "WebDAV URL",
	...
	"log_backup.table_empty":               "The log table is empty, no upload needed",
