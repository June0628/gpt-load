export default {
  ...
  keys: {
    ...
    endpointDomain: "Current Domain",
    endpointLocalIP: "Local IP",
    endpointOutboundIP: "Outbound IP",
    keyCount: "Key Count",
    ...
    balanceHistoryTitle: "Balance History - {key}",
    balanceHistoryQueriedAt: "Query Time",
    balanceHistoryEmpty: "No balance history records",
  ...
  settings: {
    ...
    logBackup: "Manual Log Backup",
    logBackupDesc:
      "Select a log table to manually backup and upload to configured external storage",
    selectTable: "Select Log Table",
    selectTablePlaceholder: "Select a log table to backup",
    uploadBackup: "Upload Backup",
    uploadAndDelete: "Upload & Delete",
    uploading: "Uploading...",
    uploadSuccess: "Log table backup uploaded successfully",
    uploadAndDeleteSuccess: "Log table backup uploaded and deleted successfully",
    uploadFailed: "Log table backup upload failed",
    autoDeleteEnabled: "Auto-delete after upload is enabled",
    loadTablesFailed: "Failed to load log tables",
    noTables: "No log tables available",
    tableDate: "Date",
    tableRows: "Records",
    rowsUnit: "rows",
    // Log upload configuration test related
    logUploadTest: "Log Upload Configuration Test",
    logUploadTestDesc: "Test if the configured external storage is accessible and working properly",
    testLogUpload: "Test Configuration",
    testTime: "Test Time",
    provider: "Provider",
    logUploadTestSuccess: "Log upload configuration test successful",
    logUploadTestFailed: "Log upload configuration test failed",
    logUploadTestError: "Error occurred while testing log upload configuration",
