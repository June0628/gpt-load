export default {
  ...
  keys: {
    ...
    endpointDomain: "現在のドメイン",
    endpointLocalIP: "ローカルIP",
    endpointOutboundIP: "外部IP",
    keyCount: "キー数",
    ...
    balanceHistory: "履歴",
    historyShort: "履歴",
    balanceHistoryTitle: "残高履歴 - {key}",
    balanceHistoryQueriedAt: "照会時刻",
    balanceHistoryEmpty: "残高履歴記録はありません",
    // キー失効設定
  ...
  settings: {
    ...
    rowsUnit: "件",
    // ログアップロード設定テスト関連
    logUploadTest: "ログアップロード設定テスト",
    logUploadTestDesc: "設定済みの外部ストレージがアクセス可能で正常に動作するかテストします",
    testLogUpload: "設定をテスト",
    testTime: "テスト時間",
    provider: "プロバイダー",
    logUploadTestSuccess: "ログアップロード設定テストが成功しました",
    logUploadTestFailed: "ログアップロード設定テストに失敗しました",
    logUploadTestError: "ログアップロード設定のテスト中にエラーが発生しました",
