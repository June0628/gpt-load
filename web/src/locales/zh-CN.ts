export default {
  ...
  keys: {
    ...
    urlCopied: "地址已复制到剪贴板",
    endpointDomain: "当前域名",
    endpointLocalIP: "内网IP",
    endpointOutboundIP: "外网IP",
    keyCount: "密钥数量",
    ...
    totalBalance: "余额总量",
    totalUsed: "已用金额",
    balanceQuerySuccess: "查询成功",
    noBalanceInfo: "暂无余额信息",
    balanceQueryConfig: "余额查询配置",
    balanceQueryConfigTooltip: "配置是否在检查密钥可用性时自动查询上游余额",
    balanceQueryEnabled: "启用余额查询",
    balanceQueryEnabledTooltip: "启用后，每次检查密钥可用性时会自动查询上游余额",
    balanceQueryEnabledDescription: "启用后系统会在验证密钥时自动查询余额信息",
    aggregateBalance: "汇总所有密钥余额",
    aggregateBalanceTooltip: "启用后，将汇总该分组下所有密钥的余额并显示总额",
    ...
    balanceHistory: "历史",
    historyShort: "历史",
    balanceHistoryTitle: "余额历史记录 - {key}",
    balanceHistoryQueriedAt: "查询时间",
    balanceHistoryEmpty: "暂无余额历史记录",
    // 密钥失效配置
  ...
  settings: {
    ...
    // 日志上传相关
    logUploadEnabled: "启用日志自动上传",
    logUploadBeforeDelete: "删除前上传",
    logUploadDirectory: "上传目录",
    logUploadFilenamePrefix: "文件名前缀",
    logUploadProvider: "上传服务商",
    logUploadTencentSecretId: "腾讯云 SecretId",
    logUploadTencentSecretKey: "腾讯云 SecretKey",
    logUploadTencentBucket: "存储桶名称",
    logUploadTencentRegion: "存储桶地域",
    logUploadWebDAVUrl: "WebDAV 地址",
    logUploadWebDAVUsername: "WebDAV 用户名",
    logUploadWebDAVPassword: "WebDAV 密码",
    providerTencent: "腾讯云 COS",
    providerWebDAV: "WebDAV",
    // 手动备份上传
    logBackup: "日志手动备份",
    logBackupDesc: "选择日志表手动备份上传到已配置的外部存储",
    selectTable: "选择日志表",
    selectTablePlaceholder: "请选择要备份的日志表",
    uploadBackup: "上传备份",
    uploadAndDelete: "上传并删除",
    uploading: "上传中...",
    uploadSuccess: "日志表备份上传成功",
    uploadAndDeleteSuccess: "日志表备份上传成功，已自动删除",
    uploadFailed: "日志表备份上传失败",
    autoDeleteEnabled: "已启用上传后自动删除",
    loadTablesFailed: "加载日志表列表失败",
    noTables: "暂无日志表",
    tableDate: "日期",
    tableRows: "记录数",
    rowsUnit: "条",
    // 日志上传配置测试相关
    logUploadTest: "日志上传配置测试",
    logUploadTestDesc: "测试当前配置的外部存储是否可以正常连接和访问",
    testLogUpload: "测试配置",
    testTime: "测试时间",
    provider: "服务商",
    logUploadTestSuccess: "日志上传配置测试成功",
    logUploadTestFailed: "日志上传配置测试失败",
    logUploadTestError: "测试日志上传配置时发生错误",
  },
  footer: {
    checking: "检查中...",
    latestVersion: "最新版本",
